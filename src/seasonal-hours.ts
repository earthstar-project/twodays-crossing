...
*/
let hourTable: Record<number, HourOf> = {
...
export let useHourOf = (): [HourOf] => {
  // Get the current seasonal hour description.
  // This will check for changes once a minute and
  // re-render the component when the hour rolls over.
  let [hourOf, setHourOf] = React.useState<HourOf>(getHourOf());
  React.useEffect(() => {
